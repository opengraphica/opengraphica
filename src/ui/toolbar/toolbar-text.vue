    ...
    <div class="flex container items-center justify-center mx-auto">
        <div class="og-toolbar-overlay">
            ...
            <el-horizontal-scrollbar-arrows>
                ...
                <el-input-group>
                    <template #prepend>
                        <span class="text-xs">{{ t('toolbar.text.font') }}</span>
                    </template>
                ...
                <el-input-group class="ml-3">
                    <template #prepend>
                        <span class="text-xs">{{ t('toolbar.text.size') }}</span>
                    </template>
                ...
                <el-input-group class="ml-3" :prepend-tooltip="t('toolbar.text.fillTooltip')">
                    <template #prepend>
                        <span class="text-xs">{{ t('toolbar.text.fill') }}</span>
                    </template>
                    <el-input-color
                        v-model="fillColor"
                        is-custom-picker
                ...
                <el-popover
                    ...
                    <h2 class="og-dock-title">{{ t('toolbar.text.alignment.title') }}</h2>
...
watch(() => fillColor.value, (newFillColor) => {
    const currentPalette = fillColorPalette.value[fillColorPaletteIndex.value];
    if (currentPalette
