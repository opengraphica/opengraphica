...
export class Glyph {
    ...
    getContours(): Contour;
    getMetrics(): Metrics;
    draw(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, x?: number, y?: number, fontSize?: number, options?: RenderOptions): void;
    drawPoints(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, x?: number, y?: number, fontSize?: number, options?: RenderOptions): void;
    drawMetrics(
        ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D,
        x?: number,
        y?: number,
...
export interface Metrics {
    ...
    topSideBearing?: number | undefined;
    bottomSideBearing?: number | undefined;
    xMax: number;
    xMin: number;
    yMax: number;
    yMin: number;
...
export function parse(buffer: ArrayBuffer, opt?: LoadOpt): Font;
