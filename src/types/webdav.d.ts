declare module 'webdav/web' {
    ...
    export interface WebDAVClient {
        ...
        putFileContents: (filename: string, data: string | BufferLike, options?: PutFileContentsOptions) => Promise<boolean>;
        partialUpdateFileContents: (filePath: string, start: number, end: number, data: string | BufferLike, options?: WebDAVMethodOptions) => Promise<void>;
