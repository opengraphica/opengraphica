...
import { TriangleFanDrawMode, TriangleStripDrawMode, TrianglesDrawMode } from 'three/src/constants';
...
function deepCloneAttribute( attribute ) {
	...
	if ( attribute.isInstancedBufferAttribute ) {
		...
		return new (InstancedBufferAttribute as any)().copy( attribute );

	}

	return new (BufferAttribute as any)().copy( attribute );
