...
import { ref, computed, onMounted, nextTick, reactive, watch, WatchStopHandle } from 'vue';
...
import ElForm from 'element-plus/lib/components/form/index';
...
const previewImages = computed<Record<string, string>>(() => {
    return (layerBlendingModePreviews as Record<string, unknown>)[formData.blendingMode] as never;
});
